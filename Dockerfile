...
ENTRYPOINT ["/bin/sh", "-c", "envsubst < /opt/traccar/conf/traccar_template.xml > /opt/traccar/conf/traccar.xml && exec java -Xms1g -Xmx1g -Djava.net.preferIPv4Stack=true -jar tracker-server.jar /opt/traccar/conf/traccar.xml"]